...
const MONTHS = [
  ...
  "nov/26", "dez/26", "jan/27", "fev/27", "mar/27", "abr/27",
];

const HOJE_IDX = 15; // abr/26

const CURRENT_TRAJECTORY = [
  392000, 385000, 401000, 410000, 398000, 415000,
  422000, 430000, 418000, 443000, 451000, 467000,
  458000, 473000, 482000, 487350,
  498000, 510000, 521000, 533000, 546000, 558000,
  571000, 583000, 596000, 609000, 622000, 636000,
];
...
const AXENYA_TRAJECTORY = [
  ...
  491000, 491500, 492000, 492000, 492500, 492500,
  493000, 493000, 493500, 493500, 494000, 494000,
];
...
function buildLineOption(showAxenya: boolean) {
    ...
    series: [
      // histórico compartilhado (cinza)
      {
        ...
        markLine: {
          ...
          label: { formatter: "Hoje", color: "#A6A7A9", fontSize: 10, position: "insideEndTop" },
        },
      },
      ...(showAxenya
        ? [
            {
              ...
              type: "line",
              data: [...nullsBefore, ...histAxenya.slice(-1), ...projAxenya.slice(1)],
              color: "#25E9C4",
...
export default function PrevisaoFaturaPage() {
  ...
  const projecao12m = CURRENT_TRAJECTORY.slice(HOJE_IDX + 1).reduce((a, b) => a + b, 0);
  const axenya12m = AXENYA_TRAJECTORY.slice(HOJE_IDX + 1).reduce((a, b) => a + b, 0);
      ...
      <OverflowBox>
        <Stack gap={2} pb={2}>
          ...
          <Typography variant="body2" color="grey.100">
            Projeção da sua fatura de benefícios e impacto potencial da gestão Axenya nos próximos 12 meses.
          </Typography>
          ...
          <Stack direction="row" flexWrap="wrap" gap={1.5} alignItems="center">
            ...
            <Button
              ...
              startIcon={showAxenya ? <EyeIcon size={14} /> : <EyeOffIcon size={14} />}
          ...
          <Card variant="outlined">
            <CardContent>
              <Stack direction="row" justifyContent="space-between" alignItems="center" mb={1.5}>
                ...
                {showAxenya && (
                  <Chip
                    ...
                    size="small"
                    sx={{ bgcolor: "rgba(37,233,196,0.12)", color: "primary.main", border: "1px solid", borderColor: "primary.main" }}
                  />
                )}
              </Stack>
              ...
              {isLoading ? (
                ...
                <ReactECharts
                  option={buildLineOption(showAxenya)}
          ...
          <Card variant="outlined">
            <CardContent>
              ...
              <Typography variant="caption" color="grey.100" display="block" mb={2}>
                Distribuição da fatura de {fmt(487350)} por categoria de utilização
              </Typography>
