...
const analyticsDashboardsMock: AnalyticsDashboard[] = [
  {
    ...
    slug: "saude-populacional",
    description: "Visão geral da saúde dos beneficiários da empresa",
    category: "Saúde",
    filters: null,
    bigquerySource: null,
  },
  {
    id: "analytics-002",
    name: "Movimentações de Beneficiários",
    slug: "movimentacoes",
    description: "Análise de inclusões, exclusões e alterações de plano",
...
export async function getAllAnalyticsDashboards(
  ...
  return {
    ...
    meta: {
      itemsPerPage: 10,
      totalItems: analyticsDashboardsMock.length,
      currentPage: 1,
      totalPages: 1,
    },
  };
